  ...
  return {
    store: {
      ...
      module: {
        html: {
          imagen:
            "https://generation-sessions.s3.amazonaws.com/ad60b588835c42a878fbc4ab00aaadec/img/html5-logo-and-wordmark-1@2x.png",
          color: "#F16529",
        },
        css: {
          imagen:
            "https://generation-sessions.s3.amazonaws.com/ad60b588835c42a878fbc4ab00aaadec/img/1200px-css-3-1@2x.png",
          color: "#29A9DF",
        },
        js: {
          imagen:
            "https://generation-sessions.s3.amazonaws.com/ad60b588835c42a878fbc4ab00aaadec/img/unofficial-javascript-logo-2-1@2x.png",
          color: "#F7DF1E",
        },
      },
    ...
    actions: {
      ...
      getExercises: async (module) => {
        try {
          ...
          const resp = await fetch(
            process.env.BACKEND_URL + `/api/exercises/${module}`
          );
          const data = await resp.json();
      ...
      // Supongamos que setStore es una función proporcionada por el contexto
      getModules: async () => {
        const url = process.env.BACKEND_URL + "/api/modules";
        ...
        try {
          ...
          if (resp.ok) {
            const data = await resp.json();
            setStore((prevStore) => ({ ...prevStore, modules: data }));
            return data;
          }
        } catch (error) {
          console.error(error);
