...
export const CourseDescrip = () => (
    ...
    <div className="m-3 text-left">
        ...
        <p>But that's not all—you'll also be introduced to the exciting world of Python,
        ...
        <p>This course will provide you with a solid foundation to become a well-rounded web developer,
